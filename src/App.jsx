...
const styles = {
  ...
  letterBox: { background: "#FFF8ED", border: "1px solid #E4D0B8", borderRadius: "3px", padding: "2.3rem 2.3rem 2rem", marginBottom: "2.5rem", boxShadow: "0 3px 14px rgba(200,132,90,0.08)" },
  letterMark: { fontFamily: "'Nanum Myeongjo', serif", fontSize: "0.9rem", color: "#A07A5A", textAlign: "center", marginBottom: "1.5rem", fontStyle: "italic", letterSpacing: "0.1em" },
  letterP: { fontFamily: "'Gowun Batang', serif", fontSize: "1rem", lineHeight: "2.1", color: "#3C2415", margin: "0 0 1.1rem", letterSpacing: "-0.005em", textAlign: "center" },
